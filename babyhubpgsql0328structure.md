...
;ALTER TABLE "public"."t01member" OWNER TO "postgres";
...
;ALTER TABLE "public"."t02baby" OWNER TO "postgres";COMMENT ON COLUMN "public"."t02baby"."babyno" IS 'AI';
...
;ALTER TABLE "public"."t03growingrecord" OWNER TO "postgres";
...
;ALTER TABLE "public"."t04forum" OWNER TO "postgres";COMMENT ON COLUMN "public"."t04forum"."forumno" IS 'ai';
...
;ALTER TABLE "public"."t05forumcomment" OWNER TO "postgres";
...
;ALTER TABLE "public"."t06pregnancyknowledge" OWNER TO "postgres";
...
;ALTER TABLE "public"."t07vaccination" OWNER TO "postgres";
...
;ALTER TABLE "public"."t08diary" OWNER TO "postgres";
...
;ALTER TABLE "public"."t09milestonedone" OWNER TO "postgres";
...
;ALTER TABLE "public"."t10education" OWNER TO "postgres";
CREATE TABLE "public"."t11forumlike" (
  "serno" int4 NOT NULL,
  "id" varchar(50) COLLATE "pg_catalog"."default",
  "forumno" int4
)
;ALTER TABLE "public"."t11forumlike" OWNER TO "postgres";
...
;ALTER TABLE "public"."t12manager" OWNER TO "postgres";
...
;ALTER TABLE "public"."t13vaccine" OWNER TO "postgres";
...
;ALTER TABLE "public"."t14milestone" OWNER TO "postgres";
CREATE TABLE "public"."t15forumtype" (
  "typeno" int4 NOT NULL,
  "managerno" varchar(20) COLLATE "pg_catalog"."default",
  "name" varchar(20) COLLATE "pg_catalog"."default"
)
;ALTER TABLE "public"."t15forumtype" OWNER TO "postgres";
...
;ALTER TABLE "public"."t16hospital" OWNER TO "postgres";
BEGIN;
